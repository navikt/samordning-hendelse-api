...
public class DatabaseTests {
    ...
    public void fetchTest() {
        ...
        Hendelse result = db.fetch(0, 20, "AAP", LocalDate.of(2030, 01, 01),LocalDate.of(2031, 02, 02)).get(0);
    ...
    public void fetchTestWithInvalidYtelsesType() {
        ...
        Hendelse result = db.fetch(0, 0, "Alderstrygd", LocalDate.of(2020, 01, 01), LocalDate.of(2021, 02, 02)).get(0);
